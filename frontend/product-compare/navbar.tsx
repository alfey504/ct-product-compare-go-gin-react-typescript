...
export function Navbar({
  ...
  return (
    <div className="flex flex-row border-b-1 border-b-gray-300 pb-5 shadow-lg">
      ...
      <button className="w-10 h-10 self-end mb-1 ml-5 bg-rose-500 rounded-lg text-white shadow-2xl" onClick={() => buttonPress(true)}>69</button>
    </div>
  );
}
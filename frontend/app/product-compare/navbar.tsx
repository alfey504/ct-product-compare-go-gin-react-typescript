  ...
  return (
    <div className=" border-b-1 border-b-gray-300 pb-5 shadow-lg">
      ...
      <div className="flex flex-col mt-5">
        ...
        <div className="mt-3">{(message == undefined)? "" : message}</div>
      </div>
      <button className="w-10 h-10 self-end mb-9 ml-5 bg-rose-500 rounded-lg text-white shadow-2xl" onClick={() => buttonPress(true)}>69</button>
      </div>

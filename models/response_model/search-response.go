...
type Product struct {
	...
	IsTire                  bool                   `json:"isTire"`
	TireCategory            interface{}            `json:"tireCategory"`
	SkuID                   string                 `json:"skuId"`
	ProductType             interface{}            `json:"productType"`
	Skus                    []interface{}          `json:"skus"`
	CategoryLevel           string                 `json:"categoryLevel"`
	FitmentTypeCode         interface{}            `json:"fitmentTypeCode"`
	...
	FeeValues               map[string]interface{} `json:"feeValues"`
